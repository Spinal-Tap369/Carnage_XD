...
def main(WIN):
    ...
    # Toggle sound button
    sound_button = pygame.Rect(WIDTH - 250, HEIGHT - 80, 200, 50)
    ...
    def redraw_window():
        ...
        pygame.draw.rect(WIN, (128, 128, 128), sound_button)
        sound_label = main_font.render("Music: ON" if sound_on else "Music: OFF", 1, (255,255,255))
        WIN.blit(sound_label, (sound_button.centerx - sound_label.get_width()/2, sound_button.centery - sound_label.get_height()/2))
